...
namespace UniversityManagementSystemWebApp.BusinessLogicLayer
{
    public class UniversityManager
    {
        ...
        public string GetRegistrationNumber(Student student)
        {
            ...
            int id = db.Students.Where(x=>(x.DepartmentId == student.DepartmentId) && (x.RegistrationDate.Year == student.RegistrationDate.Year)).ToList().Count + 1;
            if (id > 0 && id < 10)
            {
                serialNumber = "00" + id;
            }
            ...
            string registrationNumber = aDepartment.DepartmentCode + "-" + student.RegistrationDate.Year + "-" + serialNumber;
